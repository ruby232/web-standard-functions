...
exports.GeneXusCommonGeolocationInfoData = exports.GeneXusCommonGeolocation =
  void 0;
...
var GeneXusCommonGeolocation = /** @class */ (function () {
   ...
   * @return any
   */
  GeneXusCommonGeolocation.getMyLocation = function (
    minAccuracy,
    timeout,
  ...
  GeneXusCommonGeolocation.getCurrentProximityAlert = function () {
    helpers_1.notImplemented(
      "GeneXusCommonGeolocation.getCurrentProximityAlert"
    );
    return null;
  };
  /**
