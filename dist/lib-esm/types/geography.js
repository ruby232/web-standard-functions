...
var Geography = /** @class */ (function () {
  ...
  Object.defineProperty(Geography.prototype, "longitude", {
    ...
    get: function () {
      var _a;
      return (
        ((_a = this.point) === null || _a === void 0 ? void 0 : _a.longitude) ||
        0
      );
    },
    enumerable: false,
  ...
  Object.defineProperty(Geography.prototype, "latitude", {
    ...
    get: function () {
      var _a;
      return (
        ((_a = this.point) === null || _a === void 0 ? void 0 : _a.latitude) ||
        0
      );
    },
    enumerable: false,
  ...
  Geography.prototype.toGeoJson = function () {
    ...
    switch (this.featureType) {
      ...
      case "LINE":
        geoJson = {
          type: "LineString",
          coordinates: this.line.map(function (point) {
            return [point.longitude, point.latitude];
          }),
        };
        break;
